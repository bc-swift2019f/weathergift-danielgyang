...
// API Key: AIzaSyC7UpI5951TqKPHI07bxxHsicm3dKkwkmM
...
class PageVC: UIPageViewController {
    ...
    func configurePageControl() {
        let pageControlHeight: CGFloat = barButtonHeight // don't need the CGFloat, but it's a nice reminder
    ...
    //MARK:- Create View Controller Page for UIPageController
